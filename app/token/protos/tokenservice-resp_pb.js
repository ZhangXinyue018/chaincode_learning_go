...
var tokenlog_pb = require('./tokenlog_pb.js');
goog.object.extend(proto, tokenlog_pb);
...
goog.exportSymbol('proto.protos.PaginateTokenLogByFromUserNameResponse', null, global);
goog.exportSymbol('proto.protos.PaginateTokenLogByToUserNameResponse', null, global);
 ...
 * @constructor
 */
proto.protos.PaginateTokenLogByFromUserNameResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.protos.PaginateTokenLogByFromUserNameResponse.repeatedFields_, null);
};
goog.inherits(proto.protos.PaginateTokenLogByFromUserNameResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.protos.PaginateTokenLogByFromUserNameResponse.displayName = 'proto.protos.PaginateTokenLogByFromUserNameResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.protos.PaginateTokenLogByToUserNameResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.protos.PaginateTokenLogByToUserNameResponse.repeatedFields_, null);
};
goog.inherits(proto.protos.PaginateTokenLogByToUserNameResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.protos.PaginateTokenLogByToUserNameResponse.displayName = 'proto.protos.PaginateTokenLogByToUserNameResponse';
}
 ...
 * @const
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.repeatedFields_ = [4];
 ...
 * @return {!Object}
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.protos.PaginateTokenLogByFromUserNameResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.protos.PaginateTokenLogByFromUserNameResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    commonresponse: (f = msg.getCommonresponse()) && common_pb.CommonResponse.toObject(includeInstance, f),
    pagesize: jspb.Message.getFieldWithDefault(msg, 2, 0),
    bookmark: jspb.Message.getFieldWithDefault(msg, 3, ""),
    resultsList: jspb.Message.toObjectList(msg.getResultsList(),
    tokenlog_pb.TokenLogPB.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.protos.PaginateTokenLogByFromUserNameResponse}
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.protos.PaginateTokenLogByFromUserNameResponse;
  return proto.protos.PaginateTokenLogByFromUserNameResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.protos.PaginateTokenLogByFromUserNameResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.protos.PaginateTokenLogByFromUserNameResponse}
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new tokenlog_pb.TokenLogPB;
      reader.readMessage(value,tokenlog_pb.TokenLogPB.deserializeBinaryFromReader);
      msg.addResults(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.protos.PaginateTokenLogByFromUserNameResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.protos.PaginateTokenLogByFromUserNameResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCommonresponse();
  if (f != null) {
    writer.writeMessage(
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      tokenlog_pb.TokenLogPB.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.protos.CommonResponse}
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.getCommonresponse = function() {
  return /** @type{?proto.protos.CommonResponse} */ (
    jspb.Message.getWrapperField(this, common_pb.CommonResponse, 1));
};
...
/**
 * @param {?proto.protos.CommonResponse|undefined} value
 * @return {!proto.protos.PaginateTokenLogByFromUserNameResponse} returns this
*/
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.setCommonresponse = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.protos.PaginateTokenLogByFromUserNameResponse} returns this
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.clearCommonresponse = function() {
  return this.setCommonresponse(undefined);
};
 ...
 * @return {boolean}
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.hasCommonresponse = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {number}
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.getPagesize = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.protos.PaginateTokenLogByFromUserNameResponse} returns this
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.setPagesize = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.getBookmark = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.protos.PaginateTokenLogByFromUserNameResponse} returns this
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.setBookmark = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {!Array<!proto.protos.TokenLogPB>}
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.getResultsList = function() {
  return /** @type{!Array<!proto.protos.TokenLogPB>} */ (
    jspb.Message.getRepeatedWrapperField(this, tokenlog_pb.TokenLogPB, 4));
};


/**
 * @param {!Array<!proto.protos.TokenLogPB>} value
 * @return {!proto.protos.PaginateTokenLogByFromUserNameResponse} returns this
*/
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.setResultsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 4, value);
};


/**
 * @param {!proto.protos.TokenLogPB=} opt_value
 * @param {number=} opt_index
 * @return {!proto.protos.TokenLogPB}
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.addResults = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.protos.TokenLogPB, opt_index);
};
 ...
 * @return {!proto.protos.PaginateTokenLogByFromUserNameResponse} returns this
 */
proto.protos.PaginateTokenLogByFromUserNameResponse.prototype.clearResultsList = function() {
  return this.setResultsList([]);
};
 ...
 * @const
 */
proto.protos.PaginateTokenLogByToUserNameResponse.repeatedFields_ = [4];
 ...
 * @return {!Object}
 */
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.protos.PaginateTokenLogByToUserNameResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.protos.PaginateTokenLogByToUserNameResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.protos.PaginateTokenLogByToUserNameResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    commonresponse: (f = msg.getCommonresponse()) && common_pb.CommonResponse.toObject(includeInstance, f),
    pagesize: jspb.Message.getFieldWithDefault(msg, 2, 0),
    bookmark: jspb.Message.getFieldWithDefault(msg, 3, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.protos.PaginateTokenLogByToUserNameResponse}
 */
proto.protos.PaginateTokenLogByToUserNameResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.protos.PaginateTokenLogByToUserNameResponse;
  return proto.protos.PaginateTokenLogByToUserNameResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.protos.PaginateTokenLogByToUserNameResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.protos.PaginateTokenLogByToUserNameResponse}
 */
proto.protos.PaginateTokenLogByToUserNameResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.protos.PaginateTokenLogByToUserNameResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.protos.PaginateTokenLogByToUserNameResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.protos.PaginateTokenLogByToUserNameResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCommonresponse();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.protos.CommonResponse}
 */
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.getCommonresponse = function() {
  return /** @type{?proto.protos.CommonResponse} */ (
    jspb.Message.getWrapperField(this, common_pb.CommonResponse, 1));
};
...
/**
 * @param {?proto.protos.CommonResponse|undefined} value
 * @return {!proto.protos.PaginateTokenLogByToUserNameResponse} returns this
*/
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.setCommonresponse = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.protos.PaginateTokenLogByToUserNameResponse} returns this
 */
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.clearCommonresponse = function() {
  return this.setCommonresponse(undefined);
};
 ...
 * @return {boolean}
 */
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.hasCommonresponse = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {number}
 */
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.getPagesize = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.protos.PaginateTokenLogByToUserNameResponse} returns this
 */
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.setPagesize = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.getBookmark = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.protos.PaginateTokenLogByToUserNameResponse} returns this
 */
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.setBookmark = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {!Array<!proto.protos.TokenLogPB>}
 */
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.getResultsList = function() {
  return /** @type{!Array<!proto.protos.TokenLogPB>} */ (
    jspb.Message.getRepeatedWrapperField(this, tokenlog_pb.TokenLogPB, 4));
};
 ...
 * @return {!proto.protos.PaginateTokenLogByToUserNameResponse} returns this
*/
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.setResultsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 4, value);
};
 ...
 * @return {!proto.protos.TokenLogPB}
 */
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.addResults = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.protos.TokenLogPB, opt_index);
};
 ...
 * @return {!proto.protos.PaginateTokenLogByToUserNameResponse} returns this
 */
proto.protos.PaginateTokenLogByToUserNameResponse.prototype.clearResultsList = function() {
  return this.setResultsList([]);
};
