...
# Create the channel
docker exec peer0.org1.example.com peer channel create -o orderer.ordererorg.example.com:7050 -c mychannel -f /etc/hyperledger/configtx/channel.tx

# Join peer0.org1.example.com to the channel.
docker exec peer0.org1.example.com peer channel fetch config mychannel.block -c mychannel -o orderer.ordererorg.example.com:7050
docker exec peer0.org1.example.com peer channel join -b mychannel.block

# Join peer1.org1.example.com to the channel.
docker exec peer1.org1.example.com peer channel fetch config mychannel.block -c mychannel -o orderer.ordererorg.example.com:7050
docker exec peer1.org1.example.com peer channel join -b mychannel.block

# Join peer0.org2.example.com to the channel.
docker exec peer0.org2.example.com peer channel fetch config mychannel.block -c mychannel -o orderer.ordererorg.example.com:7050
docker exec peer0.org2.example.com peer channel join -b mychannel.block

# Join peer1.org2.example.com to the channel.
docker exec peer1.org2.example.com peer channel fetch config mychannel.block -c mychannel -o orderer.ordererorg.example.com:7050
